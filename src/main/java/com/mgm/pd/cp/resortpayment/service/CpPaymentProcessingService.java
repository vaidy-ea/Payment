...
public interface CpPaymentProcessingService {
    ResponseEntity<GenericResponse> processIncrementalRequest(CPPaymentIncrementalRequest incrementalRequest) throws JsonProcessingException;
    ...
    ResponseEntity<GenericResponse> processVoidRequest(CPPaymentVoidRequest voidRequest) throws JsonProcessingException;
}
