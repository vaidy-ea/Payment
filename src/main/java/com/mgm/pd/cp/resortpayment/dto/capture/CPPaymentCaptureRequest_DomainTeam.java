...
@AllArgsConstructor
//TODO: Delete
public class CPPaymentCaptureRequest_DomainTeam implements Serializable {
    ...
    @Max(value = 9999999999999L, message = "DCCControlNumber can't be greater than 9999999999")
